...
const MediaRow = ({handleClick, SearchData, searching, setSearching, setSearchTerm, searchTerm, media, dataType, showSearchBar = true }) => {
  ...
  const arrayLength = media.length
    ...
    return(
        <>
            ...
            {showSearchBar && (
            <SearchBar dataType={dataType} onSubmit={SearchData} setSearchTerm={setSearchTerm} searchTerm={searchTerm} />
            )}
            {searching? (
